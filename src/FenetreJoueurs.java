...
public class FenetreJoueurs extends JFrame {
			...
			public void actionPerformed(ActionEvent arg0) {
				try {
					if(nomField.getText().equals("") || prenomField.getText().equals(""))
						throw new Exception("Informations ne sont pas entr�s.");
	...
	public static void readFile(Joueur j, boolean gagne) {
		...
		try {
	       ...
	       System.err.println("Erreur de lecture � partir du fichier");
	    }
	...
	public static void closeInput() {
		try {
			...
			System.err.println("Erreur � fermer le fichier.");
	         System.exit(1);
		}
	}
	...
	public static void writeJoueurs() {
		...
		try {
			...
			System.err.println("Erreur � ouvrir le fichier. fin du programme.");
	        System.exit(1); 
		}
